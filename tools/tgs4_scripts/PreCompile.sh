...
#After compiling tgui, you must also copy the browserassets folder to the data/resources/ folder (remember to create it before running tgs)
cp -r browserassets "$1/../../Configuration/GameStaticFiles/data/resources/"
