...
const taskTgui = new Task('tgui')
  ...
  .provides('browserassets/tgui/tgui.bundle.css')
  .provides('browserassets/tgui/tgui.bundle.js')
  .provides('browserassets/tgui/tgui-common.bundle.js')
  .provides('browserassets/tgui/tgui-panel.bundle.css')
  .provides('browserassets/tgui/tgui-panel.bundle.js')
  .build(async () => {
...
const taskDm = new Task('dm')
  ...
  .depends('icons/**')
  .depends('interface/**')
  .depends('browserassets/tgui/tgui.html')
  .depends('browserassets/tgui/*.bundle.*')
  .depends('browserassets/tgui/*.chunk.*')
